$(document).ready(function () {
    ...
    */
    ...
    $('#btm-modal-1').click(function () {
        $('#myModal').addClass('display-block');
    });

    $('#btm-modal-2').click(function () {
        $('#myModal').addClass('display-block');
    });

    $('#btm-modal-3').click(function () {
        $('#myModal').addClass('display-block');
    });

    $('#btm-modal-4').click(function () {
        $('#myModal').addClass('display-block');
    });

    $('#btm-modal-5').click(function () {
        $('#myModal').addClass('display-block');
    });
    
    $('#btm-modal-6').click(function () {
        $('#myModal').addClass('display-block');
    });

    $('#btm-modal-7').click(function () {
        $('#myModal').addClass('display-block');
    });

    $('#btm-modal-8').click(function () {
        $('#myModal').addClass('display-block');
    });
    
    $('#btm-modal-9').click(function () {
        $('#myModal').addClass('display-block');
    });
